...
/**
 * @minions-test-runs/cli — CLI for Minions Test-runs
 *
...
import { customTypes } from '@minions-test-runs/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Test-runs'));
        console.log(chalk.dim('Execution records, turn-by-turn logs, and assertion results'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-test-runs/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-test-runs/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-test-runs')}`);
