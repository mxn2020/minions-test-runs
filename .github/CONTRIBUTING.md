# Contributing to Minions Test-runs

Thank you for your interest in contributing to Minions Test-runs!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-test-runs.git`
